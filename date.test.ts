...
test("isValid({year: 0, month: 0, day: 0})", t => t.false(isValid({year: 0, month: 0, day: 0})));
test("isValid({year: 0, month: 0, day: 1})", t => t.false(isValid({year: 0, month: 0, day: 1})));
test("isValid({year: 0, month: 1, day: 0})", t => t.false(isValid({year: 0, month: 1, day: 0})));
test("isValid({year: 0, month: 1, day: 1})", t => t.true(isValid({year: 0, month: 1, day: 1})));
test("isValid({year: 1, month: 0, day: 0})", t => t.false(isValid({year: 1, month: 0, day: 0})));
test("isValid({year: 1, month: 0, day: 1})", t => t.false(isValid({year: 1, month: 0, day: 1})));
test("isValid({year: 1, month: 1, day: 0})", t => t.false(isValid({year: 1, month: 1, day: 0})));
test("isValid({year: 1, month: 1, day: 1})", t => t.true(isValid({year: 1, month: 1, day: 1})));
test("isValid({year: -1, month: 1, day: 1})", t => t.true(isValid({year: -1, month: 1, day: 1})));
test("isValid({year: 1, month: 1, day: 1.5})", t => t.false(isValid({year: 1, month: 1, day: 1.5})));
test("isValid({year: 1, month: 1.5, day: 1})", t => t.false(isValid({year: 1, month: 1.5, day: 1})));
test("isValid({year: 1.5, month: 1, day: 1})", t => t.false(isValid({year: 1.5, month: 1, day: 1})));
test("isValid({year: 1, month: 1, day: 31})", t => t.true(isValid({year: 1, month: 1, day: 31})));
test("isValid({year: 1, month: 1, day: 32})", t => t.false(isValid({year: 1, month: 1, day: 32})));
test("isValid({year: 1, month: 2, day: 0})", t => t.false(isValid({year: 1, month: 2, day: 0})));
test("isValid({year: 1, month: 2, day: 1})", t => t.true(isValid({year: 1, month: 2, day: 1})));
test("isValid({year: 1, month: 2, day: 28})", t => t.true(isValid({year: 1, month: 2, day: 28})));
test("isValid({year: 1, month: 2, day: 29})", t => t.false(isValid({year: 1, month: 2, day: 29})));
test("isValid({year: 1, month: 3, day: 1})", t => t.true(isValid({year: 1, month: 3, day: 1})));
test("isValid({year: 1, month: 3, day: 31})", t => t.true(isValid({year: 1, month: 3, day: 31})));
test("isValid({year: 1, month: 3, day: 32})", t => t.false(isValid({year: 1, month: 3, day: 32})));
test("isValid({year: 1, month: 4, day: 1})", t => t.true(isValid({year: 1, month: 4, day: 1})));
test("isValid({year: 1, month: 4, day: 30})", t => t.true(isValid({year: 1, month: 4, day: 30})));
test("isValid({year: 1, month: 4, day: 31})", t => t.false(isValid({year: 1, month: 4, day: 31})));
test("isValid({year: 1, month: 5, day: 31})", t => t.true(isValid({year: 1, month: 5, day: 31})));
test("isValid({year: 1, month: 5, day: 32})", t => t.false(isValid({year: 1, month: 5, day: 32})));
test("isValid({year: 1, month: 6, day: 30})", t => t.true(isValid({year: 1, month: 6, day: 30})));
test("isValid({year: 1, month: 6, day: 31})", t => t.false(isValid({year: 1, month: 6, day: 31})));
test("isValid({year: 1, month: 7, day: 31})", t => t.true(isValid({year: 1, month: 7, day: 31})));
test("isValid({year: 1, month: 7, day: 32})", t => t.false(isValid({year: 1, month: 7, day: 32})));
test("isValid({year: 1, month: 8, day: 31})", t => t.true(isValid({year: 1, month: 8, day: 31})));
test("isValid({year: 1, month: 8, day: 32})", t => t.false(isValid({year: 1, month: 8, day: 32})));
test("isValid({year: 1, month: 9, day: 30})", t => t.true(isValid({year: 1, month: 9, day: 30})));
test("isValid({year: 1, month: 9, day: 31})", t => t.false(isValid({year: 1, month: 9, day: 31})));
test("isValid({year: 1, month: 10, day: 31})", t => t.true(isValid({year: 1, month: 10, day: 31})));
test("isValid({year: 1, month: 10, day: 32})", t => t.false(isValid({year: 1, month: 10, day: 32})));
test("isValid({year: 1, month: 11, day: 30})", t => t.true(isValid({year: 1, month: 11, day: 30})));
test("isValid({year: 1, month: 11, day: 31})", t => t.false(isValid({year: 1, month: 11, day: 31})));
test("isValid({year: 1, month: 12, day: 31})", t => t.true(isValid({year: 1, month: 12, day: 31})));
test("isValid({year: 1, month: 12, day: 32})", t => t.false(isValid({year: 1, month: 12, day: 32})));
test("isValid({year: 2, month: 2, day: 1})", t => t.true(isValid({year: 2, month: 2, day: 1})));
test("isValid({year: 2, month: 2, day: 28})", t => t.true(isValid({year: 2, month: 2, day: 28})));
test("isValid({year: 2, month: 2, day: 29})", t => t.false(isValid({year: 2, month: 2, day: 29})));
test("isValid({year: 3, month: 2, day: 1})", t => t.true(isValid({year: 3, month: 2, day: 1})));
test("isValid({year: 3, month: 2, day: 28})", t => t.true(isValid({year: 3, month: 2, day: 28})));
test("isValid({year: 3, month: 2, day: 29})", t => t.false(isValid({year: 3, month: 2, day: 29})));
test("isValid({year: 4, month: 2, day: 1})", t => t.true(isValid({year: 4, month: 2, day: 1})));
test("isValid({year: 4, month: 2, day: 28})", t => t.true(isValid({year: 4, month: 2, day: 28})));
test("isValid({year: 4, month: 2, day: 29})", t => t.true(isValid({year: 4, month: 2, day: 29})));
test("isValid({year: 4, month: 2, day: 30})", t => t.false(isValid({year: 4, month: 2, day: 30})));
test("isValid({year: 5, month: 2, day: 28})", t => t.true(isValid({year: 5, month: 2, day: 28})));
test("isValid({year: 5, month: 2, day: 29})", t => t.false(isValid({year: 5, month: 2, day: 29})));
test("isValid({year: 7, month: 2, day: 28})", t => t.true(isValid({year: 7, month: 2, day: 28})));
test("isValid({year: 7, month: 2, day: 29})", t => t.false(isValid({year: 7, month: 2, day: 29})));
test("isValid({year: 8, month: 2, day: 28})", t => t.true(isValid({year: 8, month: 2, day: 28})));
test("isValid({year: 8, month: 2, day: 29})", t => t.true(isValid({year: 8, month: 2, day: 29})));
test("isValid({year: 8, month: 2, day: 30})", t => t.false(isValid({year: 8, month: 2, day: 30})));
test("isValid({year: 99, month: 2, day: 28})", t => t.true(isValid({year: 99, month: 2, day: 28})));
test("isValid({year: 99, month: 2, day: 29})", t => t.false(isValid({year: 99, month: 2, day: 29})));
test("isValid({year: 100, month: 2, day: 28})", t => t.true(isValid({year: 100, month: 2, day: 28})));
test("isValid({year: 100, month: 2, day: 29})", t => t.false(isValid({year: 100, month: 2, day: 29})));
test("isValid({year: 399, month: 2, day: 28})", t => t.true(isValid({year: 399, month: 2, day: 28})));
test("isValid({year: 399, month: 2, day: 29})", t => t.false(isValid({year: 399, month: 2, day: 29})));
test("isValid({year: 400, month: 2, day: 28})", t => t.true(isValid({year: 400, month: 2, day: 28})));
test("isValid({year: 400, month: 2, day: 29})", t => t.true(isValid({year: 400, month: 2, day: 29})));
test("isValid({year: 400, month: 2, day: 30})", t => t.false(isValid({year: 400, month: 2, day: 30})));
test("isValid({year: 0, month: 2, day: 28})", t => t.true(isValid({year: 0, month: 2, day: 28})));
test("isValid({year: 0, month: 2, day: 29})", t => t.true(isValid({year: 0, month: 2, day: 29})));
test("isValid({year: 0, month: 2, day: 30})", t => t.false(isValid({year: 0, month: 2, day: 30})));
test("isValid({year: -4, month: 2, day: 28})", t => t.true(isValid({year: -4, month: 2, day: 28})));
test("isValid({year: -4, month: 2, day: 29})", t => t.true(isValid({year: -4, month: 2, day: 29})));
test("isValid({year: -4, month: 2, day: 30})", t => t.false(isValid({year: -4, month: 2, day: 30})));
test("isValid({year: -100, month: 2, day: 28})", t => t.true(isValid({year: -100, month: 2, day: 28})));
...
test("toReferenceDays({year: -400, month: 1, day: 1})", t => t.is(toReferenceDays({year: -400, month: 1, day: 1}), -146463));
test("toReferenceDays({year: -400, month: 2, day: 28})", t => t.is(toReferenceDays({year: -400, month: 2, day: 28}), -146405));
test("toReferenceDays({year: -400, month: 2, day: 29})", t => t.is(toReferenceDays({year: -400, month: 2, day: 29}), -146404));
test("toReferenceDays({year: -400, month: 3, day: 1})", t => t.is(toReferenceDays({year: -400, month: 3, day: 1}), -146403));
test("toReferenceDays({year: -400, month: 12, day: 31})", t => t.is(toReferenceDays({year: -400, month: 12, day: 31}), -146098));
test("toReferenceDays({year: -399, month: 1, day: 1})", t => t.is(toReferenceDays({year: -399, month: 1, day: 1}), -146097));
test("toReferenceDays({year: -100})", t => t.is(toReferenceDays({year: -100}), -36890));
test("toReferenceDays({year: -100, month: 1, day: 1})", t => t.is(toReferenceDays({year: -100, month: 1, day: 1}), -36890));
test("toReferenceDays({year: -100, month: 1, day: 31})", t => t.is(toReferenceDays({year: -100, month: 1, day: 31}), -36860));
test("toReferenceDays({year: -100, month: 2, day: 1})", t => t.is(toReferenceDays({year: -100, month: 2, day: 1}), -36859));
test("toReferenceDays({year: -100, month: 2, day: 28})", t => t.is(toReferenceDays({year: -100, month: 2, day: 28}), -36832));
test("toReferenceDays({year: -100, month: 3, day: 1})", t => t.is(toReferenceDays({year: -100, month: 3, day: 1}), -36831));
test("toReferenceDays({year: -99})", t => t.is(toReferenceDays({year: -99}), -36525));
test("toReferenceDays({year: -99, month: 1, day: 1})", t => t.is(toReferenceDays({year: -99, month: 1, day: 1}), -36525));
test("toReferenceDays({year: -4})", t => t.is(toReferenceDays({year: -4}), -1827));
test("toReferenceDays({year: -4, month: 1, day: 1})", t => t.is(toReferenceDays({year: -4, month: 1, day: 1}), -1827));
test("toReferenceDays({year: -4, month: 2, day: 28})", t => t.is(toReferenceDays({year: -4, month: 2, day: 28}), -1769));
test("toReferenceDays({year: -4, month: 2, day: 29})", t => t.is(toReferenceDays({year: -4, month: 2, day: 29}), -1768));
test("toReferenceDays({year: -4, month: 3, day: 1})", t => t.is(toReferenceDays({year: -4, month: 3, day: 1}), -1767));
test("toReferenceDays({year: -3})", t => t.is(toReferenceDays({year: -3}), -1461));
test("toReferenceDays({year: -3, month: 1, day: 1})", t => t.is(toReferenceDays({year: -3, month: 1, day: 1}), -1461));
test("toReferenceDays({year: -2})", t => t.is(toReferenceDays({year: -2}), -1096));
test("toReferenceDays({year: -2, month: 1, day: 1})", t => t.is(toReferenceDays({year: -2, month: 1, day: 1}), -1096));
test("toReferenceDays({year: -1})", t => t.is(toReferenceDays({year: -1}), -731));
test("toReferenceDays({year: -1, month: 1, day: 1})", t => t.is(toReferenceDays({year: -1, month: 1, day: 1}), -731));
test("toReferenceDays({year: -1, month: 12, day: 31})", t => t.is(toReferenceDays({year: -1, month: 12, day: 31}), -367));
...
test("toReferenceDays({year: 0, month: 1, day: 1})", t => t.is(toReferenceDays({year: 0, month: 1, day: 1}), -366));
test("toReferenceDays({year: 0, month: 1, day: 31})", t => t.is(toReferenceDays({year: 0, month: 1, day: 31}), -336));
test("toReferenceDays({year: 0, month: 2})", t => t.is(toReferenceDays({year: 0, month: 2}), -335));
test("toReferenceDays({year: 0, month: 2, day: 29})", t => t.is(toReferenceDays({year: 0, month: 2, day: 29}), -307));
test("toReferenceDays({year: 0, month: 3})", t => t.is(toReferenceDays({year: 0, month: 3}), -306));
test("toReferenceDays({year: 0, month: 3, day: 1})", t => t.is(toReferenceDays({year: 0, month: 3, day: 1}), -306));
test("toReferenceDays({year: 0, month: 3, day: 2})", t => t.is(toReferenceDays({year: 0, month: 3, day: 2}), -305));
test("toReferenceDays({year: 0, month: 6, day: 1})", t => t.is(toReferenceDays({year: 0, month: 6, day: 1}), -214));
test("toReferenceDays({year: 0, month: 6, day: 30})", t => t.is(toReferenceDays({year: 0, month: 6, day: 30}), -185));
test("toReferenceDays({year: 0, month: 7, day: 1})", t => t.is(toReferenceDays({year: 0, month: 7, day: 1}), -184));
test("toReferenceDays({year: 0, month: 7, day: 31})", t => t.is(toReferenceDays({year: 0, month: 7, day: 31}), -154));
test("toReferenceDays({year: 0, month: 8, day: 1})", t => t.is(toReferenceDays({year: 0, month: 8, day: 1}), -153));
test("toReferenceDays({year: 0, month: 8, day: 31})", t => t.is(toReferenceDays({year: 0, month: 8, day: 31}), -123));
test("toReferenceDays({year: 0, month: 9, day: 1})", t => t.is(toReferenceDays({year: 0, month: 9, day: 1}), -122));
test("toReferenceDays({year: 0, month: 9, day: 30})", t => t.is(toReferenceDays({year: 0, month: 9, day: 30}), -93));
test("toReferenceDays({year: 0, month: 10, day: 1})", t => t.is(toReferenceDays({year: 0, month: 10, day: 1}), -92));
test("toReferenceDays({year: 0, month: 10, day: 31})", t => t.is(toReferenceDays({year: 0, month: 10, day: 31}), -62));
test("toReferenceDays({year: 0, month: 11, day: 1})", t => t.is(toReferenceDays({year: 0, month: 11, day: 1}), -61));
test("toReferenceDays({year: 0, month: 11, day: 30})", t => t.is(toReferenceDays({year: 0, month: 11, day: 30}), -32));
test("toReferenceDays({year: 1, month: 0})", t => t.is(toReferenceDays({year: 1, month: 0}), -31));
test("toReferenceDays({year: 0, month: 12, day: 1})", t => t.is(toReferenceDays({year: 0, month: 12, day: 1}), -31));
test("toReferenceDays({year: 0, month: 12, day: 30})", t => t.is(toReferenceDays({year: 0, month: 12, day: 30}), -2));
test("toReferenceDays({year: 0, month: 12, day: 31})", t => t.is(toReferenceDays({year: 0, month: 12, day: 31}), -1));
...
test("fromReferenceDays(-146463)", t => t.deepEqual(fromReferenceDays(-146463), {year: -400, month: 1, day: 1}));
test("fromReferenceDays(-146405)", t => t.deepEqual(fromReferenceDays(-146405), {year: -400, month: 2, day: 28}));
test("fromReferenceDays(-146404)", t => t.deepEqual(fromReferenceDays(-146404), {year: -400, month: 2, day: 29}));
test("fromReferenceDays(-146403)", t => t.deepEqual(fromReferenceDays(-146403), {year: -400, month: 3, day: 1}));
test("fromReferenceDays(-146098)", t => t.deepEqual(fromReferenceDays(-146098), {year: -400, month: 12, day: 31}));
test("fromReferenceDays(-146097)", t => t.deepEqual(fromReferenceDays(-146097), {year: -399, month: 1, day: 1}));
test("fromReferenceDays(-36890)", t => t.deepEqual(fromReferenceDays(-36890), {year: -100, month: 1, day: 1}));
test("fromReferenceDays(-36860)", t => t.deepEqual(fromReferenceDays(-36860), {year: -100, month: 1, day: 31}));
test("fromReferenceDays(-36859)", t => t.deepEqual(fromReferenceDays(-36859), {year: -100, month: 2, day: 1}));
test("fromReferenceDays(-36832)", t => t.deepEqual(fromReferenceDays(-36832), {year: -100, month: 2, day: 28}));
test("fromReferenceDays(-36831)", t => t.deepEqual(fromReferenceDays(-36831), {year: -100, month: 3, day: 1}));
test("fromReferenceDays(-36525)", t => t.deepEqual(fromReferenceDays(-36525), {year: -99, month: 1, day: 1}));
test("fromReferenceDays(-1827)", t => t.deepEqual(fromReferenceDays(-1827), {year: -4, month: 1, day: 1}));
test("fromReferenceDays(-1769)", t => t.deepEqual(fromReferenceDays(-1769), {year: -4, month: 2, day: 28}));
test("fromReferenceDays(-1768)", t => t.deepEqual(fromReferenceDays(-1768), {year: -4, month: 2, day: 29}));
test("fromReferenceDays(-1767)", t => t.deepEqual(fromReferenceDays(-1767), {year: -4, month: 3, day: 1}));
test("fromReferenceDays(-1461)", t => t.deepEqual(fromReferenceDays(-1461), {year: -3, month: 1, day: 1}));
test("fromReferenceDays(-1096)", t => t.deepEqual(fromReferenceDays(-1096), {year: -2, month: 1, day: 1}));
test("fromReferenceDays(-731)", t => t.deepEqual(fromReferenceDays(-731), {year: -1, month: 1, day: 1}));
test("fromReferenceDays(-367)", t => t.deepEqual(fromReferenceDays(-367), {year: -1, month: 12, day: 31}));
test("fromReferenceDays(-366)", t => t.deepEqual(fromReferenceDays(-366), {year: 0, month: 1, day: 1}));
test("fromReferenceDays(-336)", t => t.deepEqual(fromReferenceDays(-336), {year: 0, month: 1, day: 31}));
test("fromReferenceDays(-307)", t => t.deepEqual(fromReferenceDays(-307), {year: 0, month: 2, day: 29}));
test("fromReferenceDays(-306)", t => t.deepEqual(fromReferenceDays(-306), {year: 0, month: 3, day: 1}));
test("fromReferenceDays(-214)", t => t.deepEqual(fromReferenceDays(-214), {year: 0, month: 6, day: 1}));
test("fromReferenceDays(-185)", t => t.deepEqual(fromReferenceDays(-185), {year: 0, month: 6, day: 30}));
test("fromReferenceDays(-184)", t => t.deepEqual(fromReferenceDays(-184), {year: 0, month: 7, day: 1}));
test("fromReferenceDays(-154)", t => t.deepEqual(fromReferenceDays(-154), {year: 0, month: 7, day: 31}));
test("fromReferenceDays(-153)", t => t.deepEqual(fromReferenceDays(-153), {year: 0, month: 8, day: 1}));
test("fromReferenceDays(-123)", t => t.deepEqual(fromReferenceDays(-123), {year: 0, month: 8, day: 31}));
test("fromReferenceDays(-122)", t => t.deepEqual(fromReferenceDays(-122), {year: 0, month: 9, day: 1}));
test("fromReferenceDays(-93)", t => t.deepEqual(fromReferenceDays(-93), {year: 0, month: 9, day: 30}));
test("fromReferenceDays(-92)", t => t.deepEqual(fromReferenceDays(-92), {year: 0, month: 10, day: 1}));
test("fromReferenceDays(-62)", t => t.deepEqual(fromReferenceDays(-62), {year: 0, month: 10, day: 31}));
test("fromReferenceDays(-61)", t => t.deepEqual(fromReferenceDays(-61), {year: 0, month: 11, day: 1}));
test("fromReferenceDays(-32)", t => t.deepEqual(fromReferenceDays(-32), {year: 0, month: 11, day: 30}));
test("fromReferenceDays(-31)", t => t.deepEqual(fromReferenceDays(-31), {year: 0, month: 12, day: 1}));
test("fromReferenceDays(-2)", t => t.deepEqual(fromReferenceDays(-2), {year: 0, month: 12, day: 30}));
test("fromReferenceDays(-1)", t => t.deepEqual(fromReferenceDays(-1), {year: 0, month: 12, day: 31}));
